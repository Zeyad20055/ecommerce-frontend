...
// Admin table listing products with edit/delete actions. Delegates the
// actual delete confirmation to the parent via onDeleteRequest.
              ...
              <td className="px-4 py-3 text-right">
                <div className="flex justify-end gap-2">
                  <Link
                    ...
                    className="rounded-lg p-2 text-primary-600 hover:bg-primary-50 dark:hover:bg-gray-800"
                  >
                    <FiEdit2 />
                  </Link>
                  <button
